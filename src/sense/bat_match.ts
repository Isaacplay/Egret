class bat_match extends eui.Component implements  eui.UIComponent {
public static JOINFLAG ={
    ...
    private initView(){
        this.btn_start= new eui.Button();
        this.check_closeRoom = new eui.CheckBox;
        this.btn_kick2 = new eui.Button();
        this.lab_player1 = new eui.Label();
        this.lab_player2 = new eui.Label();
        this.rect_player1 = new eui.Rect();
        this.rect_player2 = new eui.Rect();
        this.lab_userID =new eui.Label();
        this.lab_userID1 = new eui.Label();
        this.lab_userID2 = new eui.Label();
        this.lab_roomID = new eui.Label();
    ...
    private showPlayer(player:GameUser){
        this.tableID = player.tableID; 
        
        if(this.joinFlag == bat_match.JOINFLAG.CREATEROOM || this.joinFlag == bat_match.JOINFLAG.WITHROOMID){
            this.btn_start.visible = this.isOwner;
            this.img_owner.visible = this.isOwner;
            if(this.tableID == 2){
                this["btn_kick"+this.tableID].visible = this.isOwner;
            }
        }else{
		...
		this["lab_player"+this.tableID].text = this.tableID.toString();
		this["lab_player"+this.tableID].textColor = 0xffffff;
		if(player.id == GameData.gameUser.id){
			this["lab_player"+this.tableID].text = "我";
		}
